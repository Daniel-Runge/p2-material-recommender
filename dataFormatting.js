function formatMaterials(materials) {
    formattedMaterials = materials.map(element =>
    {
        formattedMaterial = {
            ...
            Sensing: element.SensingLike/(element.SensingLike + element.SensingDislike),
            Intuitive : element.IntuitiveLike/(element.IntuitiveLike + element.IntuitiveDislike),
            ...
            Reflective: element.ReflectiveLike/(element.ReflectiveLike + element.ReflectiveDislike),
            Sequential: element.SequentialLike/(element.SequentialLike + element.SequentialDislike),
