 ...
 */
function coursehtml(path, courseObj, lessonObj, learningGoalObj) {
    ...
    <main class="course">
        <div class="course-container">
            <h1>Lectures</h1>
            ${lectureOverviewhtml(lessonObj, learningGoalObj)}
...
function lectureOverviewhtml(lectures, learningGoals){
    let content = ``;
